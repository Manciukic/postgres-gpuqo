...
if __name__ == "__main__":
    ...
    # create a snowflake schema where there is 1 fact table, 16 second level
    # tables, 8 third level, 4 fourth level
    # in the first level there are no leaves (fact table), the second has
    # 8 leaves (half), the third has 4 leaves (ghalf), the fourth has 4
    # leaves (all)
